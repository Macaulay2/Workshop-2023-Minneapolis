...
assert((wittDecomp(globalA1Degree(f1).matrix))==(3,matrix(QQ,{{}})));
q=ideal {z_1,z_2};
...
T2 = QQ[w];
f2 = {w^4 + w^3 - w^2 - w};
assert( wittDecomp(globalA1Degree(f2).matrix)==(2,matrix(QQ,{{}})));
p=ideal {w+1/1};
...
u = ideal {y_1, y_2, y_3};
assert(globalA1Degree(f3).matrix == localA1Degree(f3, u));
assert(globalA1Degree(f4).matrix == localA1Degree(f4, u));
assert(globalA1Degree(f3).matrix == globalA1Degree(f4));
assert(globalA1Degree(f3).matrix == localA1Degree(f4, u));
assert(globalA1Degree(f4).matrix == localA1Degree(f3, u));
