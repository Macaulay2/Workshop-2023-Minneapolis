...
document{
    ...
    Headline => "receptiveFieldRelation -- gives the receptive field relation corresponding ot a pseudomonomial",
...
document{
    ...
    Headline => "polarizePseudomonomial -- polarizes a pseudomonomial",
...
document{
    ...
    Headline => "polarizedCanonicalIdeal -- polarized ideal generated by the canonical form",
...
document{
    ...
    Headline => "polarizedCanonicalResolution -- computes the polarized canonical resolution",
...
document{
    ...
    Headline => "canonicalResolution -- canonical resolution of a neural code",
