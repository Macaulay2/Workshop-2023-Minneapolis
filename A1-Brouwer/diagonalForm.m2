...
---------
-- diagonalForm method
-- inputs a GWClas and outputs its diagonal form as a GWClass
---------
...
diagonalForm (GrothendieckWittClass) := (GrothendieckWittClass) => (beta) -> (
    ...
    -- If the field is complex, its diagonal form is an identity matrix of the same size
    ...
    -- If the field is R, we can run wittDecompInexact to determine its Witt index and anisotropic part
