...
1. Implement the Grothendieck-Witt ring into Macaulay2. For background see [GW.pdf](./GW.pdf)
2. Implement and improve upon the algorithms from [BMP] for computing $\mathbb{A}^1$-degrees. For background see [Bezoutians.pdf](./Bezoutians.pdf)
